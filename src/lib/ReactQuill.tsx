...
import Quill, { BoundsStatic, QuillOptionsStatic, RangeStatic, Sources, StringMap } from 'quill'
    ...
    */
    setEditorContents(editor: Quill, value: Value) {
        ...
        if (typeof value === 'string') {
            console.log(editor.clipboard.convert({ html: value } as any))
            editor.setContents(editor.clipboard.convert({ html: value } as any))
