...
const SettingsBase: FC<Props & {children?: ReactNode}> = ({
  initialValues = {},
  settings = [],
  renderProps,
  id,
  ...
  const handleChange =
    (childId: string, validations: any) => (newValues: InitialValues) => {
        ...
        return (
          ...
          >
            <AccordionSummary
              ...
              expandIcon={
                canExpand && <ArrowDropDownOutlined color="inherit" />
              }
            >
              <Typography
                color="inherit"
            ...
            <AccordionDetails>
              ...
              >
                <Form className={classes.form}>
                  ...
                  <FormObserver
                    onChange={handleChange(setting.id, _settingsValidation)}
                  />
                </Form>
              </Formik>
            </AccordionDetails>
