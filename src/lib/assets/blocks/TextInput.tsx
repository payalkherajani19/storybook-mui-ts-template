...
export default {
  ...
  render: (renderProps) =>
    TextInput.render(
      renderProps,
      'text-input-1',
      getFormikKey(renderProps, 'text-input-1')
    ),
  validationSchema: (renderProps: any) => {
    const schema: any = {};
    schema[getFormikKey(renderProps, 'text-input-1')] =
      TextInput.validationSchema?.(renderProps, 'text-input-1');
    return schema;
  },
  export: () => '',
  image:
  ...
  initialValues: {
    'text-input-1': TextInput.initialValues,
  },
  settings: [
    {
      id: 'text-input-1',
