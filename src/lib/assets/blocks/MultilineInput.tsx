...
export default {
  ...
  render: (renderProps) =>
    TextInput.render(
      renderProps,
      'multiline-1',
      getFormikKey(renderProps, 'multiline-1')
    ),
  validationSchema: (renderProps: any) => {
    const schema: any = {};
    schema[getFormikKey(renderProps, 'multiline-1')] =
      TextInput.validationSchema?.(renderProps, 'multiline-1');
    return schema;
  },
  export: () => '',
  image:
