...
export default {
  ...
  render: (renderProps: RenderProps) =>
    Date.render(
      renderProps,
      'date-picker-1',
      getFormikKey(renderProps, 'date-picker-1')
    ),
  validationSchema: (renderProps: any) => {
    const schema: any = {};
    schema[getFormikKey(renderProps, 'date-picker-1')] =
      Date.validationSchema?.(renderProps, 'date-picker-1');
    return schema;
  },
  export: () => '',
  image:
  ...
  initialValues: {
    'date-picker-1': Date.initialValues,
  },
  settings: [
    {
      id: 'date-picker-1',
